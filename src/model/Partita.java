...
//	private Date dataCreazione;
	...
	public Partita(String titolo,String testo,Persona persona,String url,String urlImg,String urlVideo)
				throws NotNullableFieldException{
		this(titolo,testo,persona);
		this.url = url;
		this.urlImg = urlImg;
		this.urlVideo = urlVideo;
	}
	
	public Partita(String titolo,String testo,Persona persona) throws NotNullableFieldException{
		this();
